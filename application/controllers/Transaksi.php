...
class Transaksi extends CI_Controller 
{
    ...
    public function prosesPembelian()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $queryTemp = $this->db->query("SELECT * FROM temp_transaksi WHERE kd_trx = '$kd_trx'")->result_array();
            ...
            $queryTempStock = $this->db->query("SELECT * FROM temp_stock WHERE kd_trx = '$kd_trx'")->result_array();
